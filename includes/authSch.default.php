...
class AuthSCHClient
{
    ...
    private static $username = "asd";  // your application's id
    private static $password = "asd";  // your application's password
    private static $scope = "basic+displayName+mail+linkedAccounts+eduPersonEntitlement";      // wanted data, separated with plus sign. For more information see your website profile on auth.sch.bme.hu.
