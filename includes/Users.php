...
class Users
{
    ...
    public function pushTable()
    {
        ...
        $mysql->query("CREATE TABLE `pipaweb`.`users` ( `id` INT NOT NULL AUTO_INCREMENT , `username` VARCHAR(256) NOT NULL , `name` VARCHAR(256) NULL , `oauth_internal_id` VARCHAR(256) NULL , `admin` INT NOT NULL DEFAULT '0' , `password` VARCHAR(256) NULL , `salt` VARCHAR(256) NULL , `super_admin` INT NOT NULL DEFAULT '0' , `email` VARCHAR(256) NULL DEFAULT NULL , `easter_egg_id` INT NULL DEFAULT NULL , `last_login` DATETIME NULL DEFAULT NULL, `admin_of` VARCHAR(255) NULL DEFAULT NULL,  PRIMARY KEY (`id`)) ENGINE = InnoDB;");
    }
