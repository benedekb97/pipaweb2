...
class Pipes
{
    ...
    public function pushTable()
    {
        ...
        $mysql->query("CREATE TABLE `pipaweb`.`pipes` ( `id` INT NOT NULL AUTO_INCREMENT , `type` VARCHAR(256) NOT NULL , `created` DATETIME NOT NULL , `ready` INT NULL DEFAULT '0' , `dying` INT NULL DEFAULT '0' , `preparing` INT NULL DEFAULT '0' , `created_by` INT NOT NULL , `location_id` INT NULL DEFAULT '1' , `created_static` DATETIME NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;");
    }
    ...
    public function newPipe($type, $user_id, $location_id)
    {
        ...
        $mysql->query("INSERT INTO pipes (type,created,created_by,location_id,created_static) VALUES ('$type',NOW(),'$user_id','$location_id',NOW())");
